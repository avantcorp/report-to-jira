<div class="fixed bottom-2 right-2 md:bottom-4 md:right-4 z-[9999] text-gray-800">
    ...
    <form id="reportIssuesPopup" action="{{ route('report-to-jira') }}" method="POST" class="hidden absolute -bottom-2 -right-2 md:-bottom-4 md:-right-4 w-96 max-w-[100vw] rounded-t p-2 md:p-4 border border-gray-300 bg-gray-200">
        @csrf
